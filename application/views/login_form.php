...
<head>
  ...
  <style>
    ...
    html {
      ...
      margin: 0;
      overflow: hidden;
      /* Nonaktifkan scroll pada halaman */
    }
  ...
  <div class="login-box">
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <img src="<?= base_url ('assets/dist/images/logos/unilever-logo.png'); ?>" alt="Unilever Logo" class=""
          width="35" />
        ...
        <form action="<?= site_url ('auth/login'); ?>" method="post">
          <div class="input-group mb-2">
            <div class="form-floating">
              ...
              <label for="loginEmail" class="text-primary fs-7">Username</label>
            </div>
          </div>
