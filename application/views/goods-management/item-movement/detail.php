                    ...
                    <div class="row">
                      <div class="col-md-12 col-sm-12 col-12">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-2" style="margin:0px;">
                            <input type="text" class="form-control" id="inputEmail3" value="<?php echo myNum($material->initial_stock);?> Weeks"/>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <div class="col-sm-2" style="margin:0px;">
                          ...
                          <div class="col-sm-2" style="margin:0px;">
                            <input type="text" class="form-control" id="inputEmail3" value="<?php echo $material->item_name;?> - <?php echo $material->size;?> <?php echo $material->uom;?>"/>
                          </div>
                          <div class="col-sm-2" style="margin:0px;">
                          ...
                          <div class="col-sm-2" style="margin:0px;">
                            <input type="text" class="form-control" id="inputEmail3" value="<?php echo $material->gen_lead_time;?> Days"/>
                          </div>
                          <div class="col-sm-2" style="margin:0px;">
                          ...
                          <div class="col-sm-2" style="margin:0px;">
                            <input type="text" class="form-control" id="inputEmail3" value="<?php echo myNum($material->standard_safety_stock);?>"/>
                          </div>
                        </div>
                      </div>           
                    </div>                                        
                    ...
                    <div class="row" style="margin:2px;">
                                    ...
                                    <div class="row table-responsive">
                                        ...
                                        <thead  style="text-align: center;">
                                            <tr >
                                                <th style="color: #fff;background-color:#001F82;text-align: center;vertical-align: middle;width:250px;" rowspan="3">Period</th>
                                                <th style="color: #fff;background-color:#001F82;text-align: center;vertical-align: middle;width:80px;" rowspan="3">Initial Value</th>
                                                <th style="color: #fff;background-color:#001F82;text-align: center;vertical-align: middle;" colspan="<?php echo 12;?>"><?php echo date('Y');?> Week</th>
                                            </tr>
                                            <tr >
                                                <?php for($i=1;$i<=12;$i++){ ?>
                                            ...
                                            <tr >
                                                <?php for($i=1;$i<=12;$i++){ ?>
                                                  <th style="text-align: center;">
                                                    <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modal-edit-value-<?php echo $i;?>">
                                        ...
                                        <tbody style="white-space:nowrap;vertical-align:center;">
                                            ...
                                            <td  style="text-align: center;"><?php echo myNum(min($material->initial_stock, $material->standard_safety_stock));?></td>
                                            <?php for($i=1;$i<=12;$i++){ ?>
                            ...
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel" class="text-primary" style="color: #001F82;font-weight:600;">Week <?php echo $i;?> - <?php echo date('Y');?></h5>
                                  ...
                                  <div class="row">
                                            <div class="col-12">
                                              <div class="row">
                                                ...
                                                <div class="col-6">
                                                  <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="name@example.com" name="stock_on_hand" value ="<?php echo $item_movement[$i-1]->stock_on_hand;?>">
