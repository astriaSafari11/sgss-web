        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-6">
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInputDate" placeholder="dd-mm-yyyy" name="date"
            ...
            <div class="col-6">
              <div class="form-floating mb-3">
                <select class="form-select" id="purchase-reason" data-placeholder="Choose Purchase Reason"
                  name="purchase_reason" required>
                  <option></option>
                ...
                <label for="floatingSelect" class="fw-bold text-primary" style="font-size: 14px;">Purchase
                  Reason</label>
              </div>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <div class="form-floating mb-3">
                <input type="name" class="form-control" id="floatingInput" placeholder="name@example.com" name="area"
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input type="file" name="attachment" class="form-control d-none" id="attachmentInput" accept="*/*"
                    style="width: 100%;">
              ...
              <table class="table table-bordered" style="width:100%;">
                <thead>
                  <tr>
                    ...
                    <th style="color: #fff;background-color: #001F82;text-align: center;">Lead Time (days)</th>
                    ...
                    <th style="color: #fff;background-color: #001F82;text-align: center;">Remaining Budget</th>
                    <th style="color: #fff;background-color: #001F82;text-align: center;">Savings</th>
                    <th style="color: #fff;background-color: #001F82;text-align: center;">Saving Value</th>
                    <th style="color: #fff;background-color: #001F82;text-align: center;">Lead Time Impact</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td style="vertical-align: middle;text-align: center;font-size: 14px;">
                      <?php echo $detail->item_code; ?> - <?php echo $detail->item_name; ?> <?php echo $detail->size; ?>
                      <?php echo $detail->uom; ?>
                    </td>
                    <td style="vertical-align: middle; font-size: 14px; padding: 8px;">
                      <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                        <span style="flex-grow: 1; text-align: center;"><?php echo $detail->qty; ?></span>
                        <button type="button" class="btn btn-primary btn-sm rounded-circle p-2.1"
                          style="margin-left: 3px;" data-bs-toggle="modal" data-bs-target="#modal-edit-qty">
                          <i class="fa-solid fa-pen text-white"></i>
                        </button>
                      </div>
                    </td>

                    <td style="vertical-align: middle;text-align: center;font-size: 14px;"><?php echo $detail->uom; ?>
                    </td>
                    <td style="vertical-align: middle; font-size: 14px; padding: 8px;">
                      <div style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
                        <span style="flex-grow: 1; text-align: center;"><?php echo $detail->vendor_name; ?></span>
                        <button type="button" class="btn btn-primary btn-sm rounded-circle p-2.1"
                          style="margin-left: 3px;" data-bs-toggle="modal" data-bs-target="#modal-edit-vendor">
                          <i class="fa-solid fa-pen text-white"></i>
                        </button>
                      </div>
                    </td>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" style="width:100%;">
                ...
                <tbody>
                  <tr>
                    <td style="vertical-align: middle;text-align: center;font-size: 14px;">
                      <?php echo $planned->item_code; ?> - <?php echo $planned->item_name; ?>
                    </td>
                    <td style="vertical-align: middle;text-align: center;font-size: 14px;">
                      <?php echo myNum ($planned->qty); ?>
                    </td>
                    <td style="vertical-align: middle;text-align: center;font-size: 14px;"><?php echo $planned->uom; ?>
                    </td>
                    <td style="vertical-align: middle;text-align: center;font-size: 14px;">
                      <?php echo $planned->vendor_code; ?> - <?php echo get_vendor_name ($planned->vendor_code); ?>
                    </td>
                    <td style="vertical-align: middle;text-align: right;font-size: 14px;">
                      <?php echo myNum (get_vendor_price ($planned->vendor_code, $planned->item_code)); ?>
                    </td>
                    <td style="vertical-align: middle;text-align: right;font-size: 14px;">
                      <?php echo myNum (get_vendor_price ($planned->vendor_code, $planned->item_code) * $planned->qty); ?>
                    </td>
                    <td style="vertical-align: middle;text-align: center;font-size: 14px;">
                      <?php echo myDecimal (calculate_savings (get_vendor_price ($planned->vendor_code, $planned->item_code), get_baseline_price ($detail->item_id, 'target'))); ?>
                      %
                    </td>
                  </tr>
                </tbody>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" style="width:100%;">
                <thead>
                  <tr>
                    <th style="color: #fff;background-color:rgb(121, 121, 122);text-align: center;">Target Price / item
                    </th>
                    <th style="color: #fff;background-color:rgb(121, 121, 122);text-align: center;">Budget Price / item
                    </th>
          ...
          <div class="card-footer text-end">
            <button class="btn btn-sm btn-danger custom-btn-danger" type="button"
              style="font-weight: 600; border-radius: 50px; color:#001F82; width: 150px;" onclick="location.reload();">
              Reset
            </button>
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <select class="form-select" id="vendor" data-placeholder="Choose Vendor" name="vendor" required>
                      ...
                      { ?>
                        <option value="<?php echo $row->vendor_code; ?>"><?php echo $row->vendor_name; ?> - Item Price :
                    ...
                    <table class="table table-bordered" style="width:100%;">
                      <thead>
                        <tr>
                          ...
                          <th style="color: #fff;background-color: #001F82;text-align: center;">Total Price (Rp.)</th>
                          <th style="color: #fff;background-color: #001F82;text-align: center;">Savings</th>
                          <th style="color: #fff;background-color: #001F82;text-align: center;">Savings Value</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
