        ...
        <div class="card">
            <div class="card-header">
                <div class="card-tools">
                    <a href="<?= site_url ('service_master/add_vendor'); ?>"
                    ...
                    <table id="table-vendor" class="table table-striped table-bordered" width="100%">
                        <thead style="text-align: center;white-space:nowrap;">
                            <tr>
                                ...
                                <th style="color: #fff;background-color: #001F82;text-align: center;">Additional Margin
                                </th>
                                <th style="color: #fff;background-color: #001F82;text-align: center;">Last Transaction
                                </th>
                                ...
                                <th style="color: #fff;background-color: #001F82;text-align: center;">Total Spend YTD
                                </th>
...
<script>
    $(document).ready(function () {
        $('#table-vendor').DataTable({
            ...
            "ordering": false,
            "ajax": {
                "url": "<?= site_url ('service_master/get_master_vendor_list'); ?>",
                "type": "POST"
            },
            "order": [],
            "columnDefs": [
