<form action="<?= site_url ('service_master/update_vendor'); ?>" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="col-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput" placeholder="Vendor Code"
                                    name="vendor_code" value="<?php echo $vendor->vendor_code; ?>" required readonly>
                        ...
                        <div class="col-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" name="vendor_name"
                                    value="<?php echo $vendor->vendor_name; ?>" required>
                        ...
                        <!-- <div class="col-4">
                            <div class="form-floating mb-3">
                                <input type="number" min="0" class="form-control" id="floatingInput"
                                    placeholder="name@example.com" name="est_lead_time"
                                    value="<?php echo $vendor->est_lead_time; ?>">
                        ...
                        <div class="col-4">
                            <div class="form-floating mb-3">
                                <select class="form-select" aria-label="Select Channel" id="vendor_channel"
                                    style="height: 56px;" name="vendor_channel" required>
                                    <option value=""> -- Select Channel --</option>
                                    <option value="COUPA" <?php echo $vendor->vendor_channel == 'COUPA' ? 'selected' : ''; ?>>COUPA</option>
                                    <option value="3P" <?php echo $vendor->vendor_channel == '3P' ? 'selected' : ''; ?>>3P
                                    </option>
                        ...
                        <div class="col-4">
                            <div class="form-floating mb-3">
                                <select class="form-select" aria-label="Select Validity" id="validity"
                                    style="height: 56px;" name="validity" required>
                                    <option value=""> -- Select Validity --</option>
                                    <option value="VALID" <?php echo $vendor->validity == 'VALID' ? 'selected' : ''; ?>>
                                        VALID</option>
                        ...
                        <div class="col-4">
                            <div class="form-floating mb-3">
                                <select class="form-select" aria-label="Select Category" id="category"
                                    style="height: 56px;" name="category" required>
...
<script>
    ...
    function get_vendor_category(id) {
        $.post(URL_AJAX + "/get_vendor_service_category", { id }, function (o) {
            $('#category').html(o);
        });
    }  
</script>