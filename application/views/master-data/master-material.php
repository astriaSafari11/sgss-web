          ...
          <table id="table-vendor" class="table table-striped table-bordered" width="100%">
            <thead style="text-align: center;">
              <tr>
                ...
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">Item Code
                </th>
                <th
                  style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;white-space:nowrap;">
                  Item Name
                </th>
                <th
                  style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;white-space:nowrap;">
                ...
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">LT_PR_PO
                </th>
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">
                  LT_PO_TO_DELIV</th>
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">Total Lead
                  Time</th>
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">Lot Size
                </th>
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">Order Cycle
                </th>
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">Initial
                  Stock</th>
                <th style="color: #fff;background-color: #001F82;text-align: center;vertical-align:middle;">Standard
                  Safety Stock</th>
              </tr>
            </thead>
