            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="floatingInput" name="factory_name" required>
                  <label for="floatingInput" class="fw-bold text-primary">Factory Name</label>
...
<script>
  $(document).ready(function () {
    var table = $('#factory_table').DataTable({
      scrollX: true,
      "processing": true,
      "serverSide": true,
      "ordering": false,
    ...
    $("body").on("submit", "#form-add", function (e) {
      ...
      $.ajax({
        type: 'POST',
        url: "<?php echo site_url ('master_data/save_factory') ?>",
        data: data,
        data: $(this).serialize(),
        success: function (response) {
