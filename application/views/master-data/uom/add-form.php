...
<form action="<?= site_url ('master_data/save_uom'); ?>" method="post" class="needs-validation" novalidate>
  <div class="row mb-2">
    <div class="col-sm-6">
      <a href="<?= site_url ('master_data/uom_list'); ?>" class="btn btn-sm btn-outline-primary position-relative"
      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-6">
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" name="uom_location" required>
                <label for="floatingInput" class="fw-bold text-primary">UoM Location</label>
                <div class="invalid-feedback">This field is required.</div>
              </div>
            </div>
            <!--end::Col-->
...
<script>
  ...
  function get_uom_category(id) {
    $.post(URL_AJAX + "/get_uom_category", { id }, function (o) {
      $('#category').html(o);
    });
  }  
</script> -->