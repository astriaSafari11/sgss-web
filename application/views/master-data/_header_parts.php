<div class="btn-group">
  <button type="button" class="btn btn-sm btn-outline-primary dropdown-toggle"
    style="font-weight: 600; border-radius: 50px; white-space:nowrap;width:150px" data-bs-toggle="dropdown"
    aria-expanded="false">
    Master Data
  </button>
...
<a type="button" class="btn btn-sm btn-outline-primary position-relative"
  style="font-weight: 600; border-radius: 50px; width: 150px;" href="<?= site_url ('master_data/generate') ?>">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <a href="<?= site_url ('master_data/generate_template') ?>" type="button"
