...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-mini sidebar-collapse bg-body-tertiary">
    ...
    <div class="app-wrapper">
      <!--begin::Header-->
<nav class="app-header navbar navbar-expand bg-body align-items-center">
  <!--begin::Container-->
...
<li class="nav-item dropdown d-flex flex-column align-items-start me-4">
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end align-items-center">
        <!--begin::User Image-->
        <li class=" text-bg-primary text-center align-items-center user-menu" style="height: 150px;">
            <img src="<?= base_url('assets/dist/assets/img/user2-160x160.jpg');?>" class="rounded-circle shadow" alt="User Image" style="width: 60px;height: 60px;"/>
            <p>
        ...
        <li class="user-footer text-center">
            <a href="<?= site_url('auth/logout');?>" class="btn btn-flat btn-outline-primary w-100 rounded-0">Sign out</a>
        </li>
        <!--end::Menu Footer-->
    </ul>
</li>
<!--end::User Info (Factory + Username)-->
            ...
            >
              ...
              <li class="nav-item sidebar">
                ...
                <i class="bi bi-person-gear text-primary" style="font-size: 1.7rem;"></i>
                  <p class="ms-2">User Management</p>
                </a>
              </li>
